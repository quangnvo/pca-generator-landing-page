...
const ScreenshotBanner = () => {
    return (
        <div className="relative h-[55vh] md:h-[75vh] w-full md:w-9/12 mx-auto overflow-hidden border border-gray-300 rounded-md shadow-xl image-scroll-from-top-to-bottom">
            <img
